      ...
      <TooltipAnchor
        ...
        render={
          <button
            ...
            disabled={isUploadDisabled}
            className={cn(
              'lph-attach-trigger flex size-9 items-center justify-center rounded-full p-1 transition-colors hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-opacity-50',
            )}
            onKeyDownCapture={(e) => {
              if (!inputRef.current) {
                return;
