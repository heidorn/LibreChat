...
export default function Conversation({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'lph-convo-item group relative flex h-12 w-full items-center rounded-md outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--lph-orange-soft)] md:h-9',
        isActiveConvo || isPopoverActive
          ? 'lph-convo-item-active'
          : 'hover:bg-[var(--lph-bg-panel-hover)]',
      )}
      role="button"
